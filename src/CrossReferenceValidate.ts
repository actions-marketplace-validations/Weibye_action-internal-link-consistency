import { FileData,  ValidatedFileData, ValidFlags } from "./FileData";

export function CrossReference(diskExamples: FileData[], cargoExamples: FileData[], readmeExamples: FileData[]) {
...
function GetValidFlags(disk : FileData | undefined, cargo : FileData | undefined, readme: FileData | undefined) {
    let diskName = false;
    let cargoName = false;
...
function FindMatchingElement(data: FileData, listToSearchThrough: FileData[]) {
